        ...
        <div class="container right-panel-active">
            ...
            <div class="container__form container--signup">
                <form action="MainController" class="form" method="POST">
                    ...
                    <input type="text" placeholder="Tên đăng nhập" class="input" maxlength="50" name="txtUsername" id="username" required/>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isSeller" id="inlineRadio1" value="0" checked>
                        <label class="form-check-label" for="inlineRadio1">Người mua</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isSeller" id="inlineRadio2" value="1">
                        <label class="form-check-label" for="inlineRadio2">Người bán</label>
                    </div>
            ...
            <div class="container__overlay">
                <div class="overlay">
                    <div class="overlay__panel overlay--left">
                        <button class="btn" id="signIn">Đã có tài khoản</button>
                    </div>
                    <div class="overlay__panel overlay--right">
                        <button class="btn" id="signUp">Chưa có tài khoản</button>
                    </div>
                </div>
            </div>
        </div>
