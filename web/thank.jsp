<%-- 
    Document   : thank
    Created on : Mar 8, 2021, 10:22:04 PM
    Author     : KyNQH
--%>
        ...
        <div class="section">
            <div class="container">
                <div class="jumbotron text-center">
                    ...
                    <p class="lead">Mã đơn hàng của bạn: <strong>${sessionScope.orderID}</strong>. Đơn hàng đã được ghi nhận.</p>
                    <hr>
                    <p>
                        Xem thông tin đơn hàng<a href="searchOrder.jsp"> tại đây</a>
                    </p>
                    <p class="lead">
                        <a class="btn btn-primary btn-sm" href="home" role="button">Trở về trang chủ</a>
                    </p>
                </div>
            </div>
        </div>
